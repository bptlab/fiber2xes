...
def test_time():
    ...
    one_before = Time(one_event_before=timestamp)
    all_before = Time(all_events_before=timestamp)

    one_after = Time(one_event_after=timestamp)
    all_after = Time(all_events_after=timestamp)
