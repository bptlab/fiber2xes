...
def test_vocabulary_lookup():
    ...
    assert termC is None
    assert termNoTargetColumn is None
    assert termNoSearchColumn is None
...
def test_translate_procedure():
    ...
    event_context_a, translation_a = translator.translate_procedure(
        None, "some_code", verbose=False)

    assert event_context_a == "UNKNOWN"
    assert translation_a is None
...
def test_translate_material():
    event_context_a, translation_a = translate_material(None, verbose=False)
...
def test_translate_procedure_to_event():
    ...
    procedure_event_with_code = MockEvent(
        context_procedure_code="S99.912A", context_name="ICD-10", procedure_description="SomeDescription")
    ...
    event_name_4, event_description_4, event_type_4, anamnesis_4, event_context_4, event_code_4 = translator.translate_to_event(
        procedure_event_with_code, False)
...
def test_translate_diagnosis_to_event():
    ...
    diagnosis_event_with_code = MockEvent(
        context_diagnosis_code='S99.912A', context_name="ICD-10", description="SomeDescription")

    diagnosis_event_2 = MockEvent(context_diagnosis_code='SomeDiagnosisCode',
    ...
    event_name_2, event_description_2, event_type_2, anamnesis_2, event_context_2, event_code_2 = translator.translate_to_event(
        diagnosis_event_with_code, False)
...
def test_translate_material_to_event():
    material_event_with_code = MockEvent(context_material_code='SomeMaterialCode',
    ...
    event_name_1, event_description_1, event_type_1, anamnesis_1, event_context_1, event_code_1 = translator.translate_to_event(
        material_event_with_code, False)
